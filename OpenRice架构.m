typedef enum {
    AdvancedSearch_RefineSearch,
    AdvancedSearch_CouponType,
    AdvancedSearch_BookMarkType,
    AdvancedSearch_Area,
    AdvancedSearch_District,
    AdvancedSearch_Landmark,
    AdvancedSearch_Cuisine,
    AdvancedSearch_Dish,
    AdvancedSearch_RestaurantTypes,
    AdvancedSearch_Feature,
    AdvancedSearch_Price,
    AdvancedSearch_OnlineReservation,
    AdvancedSearch_Keywords,
    AdvancedSearch_AE,
    AdvancedSearch_BuffetCategory,
    AdvancedSearch_BuffetPeriod,
    AdvancedSearch_BuffetTag,
    AdvancedSearch_BuffetPriceRange,
    AdvancedSearch_HotpotCategory,
    AdvancedSearch_HotpotPrice,
    AdvancedSearch_HotpotPriceRange,
    AdvancedSearch_HotpotCuisine,
    AdvancedSearch_HotpotCondition,
    AdvancedSearch_HotpotBufferKeywords,
    AdvancedSearch_CouponKeywords,
	AdvancedSearch_LiveTv,
	AdvancedSearch_VipRoom,
	AdvancedSearch_OnePersonOnePot,
	AdvancedSearch_Outdoor
}SearchListType;
--------------------------------------------------------------------------------
